...
import com.example.computer.use.demo.playwright.ClickAtParameter
...
class ClickAtToolCallback(
    ...
    override fun call(toolInput: String): ToolCallResult {
        println("click at...")
        val parameter = jacksonObjectMapper().readValue<ClickAtParameter>(toolInput)
        playwrightService.clickAt(parameter)
